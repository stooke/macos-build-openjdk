...
zip -r "$BUILD_DIR/$JDK_BASE-$BUILD_TARGET_ARCH$WITH_JAVAFX_STR.zip" $JDK_BASE-$BUILD_TARGET_ARCH$WITH_JAVAFX_STR
mv $JDK_BASE-$BUILD_TARGET_ARCH$WITH_JAVAFX_STR "$JDK_IMAGE_DIR"
